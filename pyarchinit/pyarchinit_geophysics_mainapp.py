...
class pyarchinit_Geophysics(QDialog, Ui_DialogGeo):
    ...
    CONVERSION_DICT = {ID_TABLE: ID_TABLE, "Sito": "sito", "Progetto": "progetto", "Metodo": "metodo", "Anno": "anno",
        ...
        "X": 'x', "Y": 'y', "Z": 'z', "Data": "date", "Frequenza": "frequenza", "Risoluzione": "risoluzione",
    ...
    SORT_ITEMS = [ID_TABLE, "Sito", "Progetto", "Metodo", "Anno", "Settore", "Area", "Griglia", "Piano di Campagna",
        ...
        "X", "Y", "Z", "Data", "Frequenza", "Risoluzione", "Massima Profondita'", "Range(ns)"]

    TABLE_FIELDS = ["sito", "progetto", "metodo", "anno", "settore", "area", "griglia", "pdc", "quota", "descrizione",
        "interpretazione", 'schedatore', 'data_schedatura', 'modello', 'velocita', 'x', 'y', 'z', "date", "frequenza",
        "risoluzione", "max_prof", "range", "bibliografia"]

    TABLE_FIELDS_UPDATE = ["sito", "progetto", "metodo", "anno", "settore", "area", "griglia", "pdc", "quota",
        "descrizione", "interpretazione", 'schedatore', 'data_schedatura', 'modello', 'velocita', 'x', 'y', 'z', "date",
        "frequenza", "risoluzione", "max_prof", "range", "bibliografia"]
    ...
    def generate_list_pdf(self):
        ...
        for i in range(len(self.DATA_LIST)):
            data_list.append({str(self.DATA_LIST[i].id_grid),  # 0 - id_invlap
                ...
                unicode(self.DATA_LIST[i].y),  # 17 - y
    ...
    def insert_new_rec(self):
        ...
        try:
            ...
            data = self.DB_MANAGER.insert__geophysics_values(
	            ...
	            unicode(self.lineEdit_z.text()),  # 22
    ...
    def on_pushButton_search_go_pressed(self):
        ...
        if self.BROWSE_STATUS != "f":
            ...
            search_dict = {self.TABLE_FIELDS[0]: "'" + unicode(self.comboBox_sito.currentText()) + "'",
                ...
                self.TABLE_FIELDS[19]: "'" + unicode(self.lineEdit_x.currentText()) + "'",
                self.TABLE_FIELDS[20]: "'" + unicode(self.lineEdit_y.currentText()) + "'",
                self.TABLE_FIELDS[21]: "'" + unicode(self.lineEdit_z.currentText()) + "'",
    ...
    def set_LIST_REC_TEMP(self):
        ...
        self.DATA_LIST_REC_TEMP = {unicode(self.comboBox_sito.currentText()),  # 1 - Sito
            ...
            unicode(self.comboBox_modello.currentText()),  # 14 - modello
            unicode(self.comboBox_velocita.currentText()),  # 15 - velocita
            unicode(self.lineEdit_x.currentText()),  # 16 - x
            unicode(self.lineEdit_y.currentText()),  # 17 - y
            unicode(self.lineEdit_z.currentText()),  # 18 - z
